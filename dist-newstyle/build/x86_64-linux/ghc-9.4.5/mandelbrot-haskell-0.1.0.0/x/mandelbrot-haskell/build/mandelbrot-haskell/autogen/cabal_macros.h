...
/* package mandelbrot-haskell-0.1.0.0 */
#ifndef VERSION_mandelbrot_haskell
#define VERSION_mandelbrot_haskell "0.1.0.0"
#endif /* VERSION_mandelbrot_haskell */
#ifndef MIN_VERSION_mandelbrot_haskell
#define MIN_VERSION_mandelbrot_haskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_mandelbrot_haskell */
...
#define CURRENT_COMPONENT_ID "mandelbrot-haskell-0.1.0.0-inplace-mandelbrot-haskell"
